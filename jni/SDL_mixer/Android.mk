...
ifeq ($(SUPPORT_MP3_SMPEG),true)
    ...
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/bitwindow.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/filter.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/filter_2.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/hufftable.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/MPEGaudio.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/mpeglayer1.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/mpeglayer2.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/mpeglayer3.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/mpegtable.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/audio/mpegtoraw.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/MPEG.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/MPEGlist.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/MPEGring.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/MPEGstream.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/MPEGsystem.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/plaympeg.c
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/smpeg.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/decoders.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/floatdct.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/gdith.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/jrevdct.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/motionvec.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/MPEGvideo.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/parseblock.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/readfile.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/util.cpp
    LOCAL_SRC_FILES += external/smpeg2-2.0.0/video/video.cpp
